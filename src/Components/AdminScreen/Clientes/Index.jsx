...
const Clientes = () => {
  ...
  const buscaCliente = async ()=>{
    let request = await fetch('https://api-rest-client.herokuapp.com/clientes/')
...
<table>
  <thead>
    <tr>
      ...
      <th>Nome</th>
      <th className={Styles.idade}>Email</th>
      <th>CPF</th>
      <th className={Styles.cargo}>Quarto</th>
  ...
  <tr key={cli.ID}>      
    ...
    <td><img className={Styles.img} id={cli.ID} onClick={callUpdate} src={editar} alt="Atualizar"/> <img className={Styles.img} id={cli.ID} onClick={callConfirm} src={lixeira} alt="Deletar"/></td>
