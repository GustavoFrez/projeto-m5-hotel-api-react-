...
const Mobilia = () => {
  ...
  const buscaMobilia = async () => {
    let request = await fetch('https://warm-cliffs-31075.herokuapp.com/mobilia/')
        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Tipo de Mobilia</th>
              <th className={Styles.idade}>Cor</th>
              <th>Manutenção</th>
          ...
          <tbody>
            {mobilias.map(mob => (
              <tr key={mob.ID}>
                ...
                <td><img className={Styles.img} id={mob.ID} onClick={callUpdate} src={editar} alt="Atualizar" /> <img className={Styles.img} id={mob.ID} onClick={callConfirm} src={lixeira} alt="Deletar" /></td>
